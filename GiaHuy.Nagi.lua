...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=100663458322564";
v24.Parent = v23;
...
v16.Home:AddButton({
    ...
    Callback = function()
        setclipboard("https://discord.gg/7VunMzeX");
    end
});
    ...
    task.spawn(function()
        while task.wait() do
            pcall(function()
                ...
                if (v793 == "http://www.roblox.com/asset/?id=100663458322564") then
                    FullMoonStatus = "100%";
                elseif (v793 == "http://www.roblox.com/asset/?id=100663458322564") then
                    FullMoonStatus = "75%";
                elseif (v793 == "http://www.roblox.com/asset/?id=100663458322564") then
                    FullMoonStatus = "50%";
                elseif (v793 == "http://www.roblox.com/asset/?id=100663458322564") then
    ...
    function getHighestPoint()
        ...
        for v728, v729 in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
            if v729:IsA("MeshPart") then
                if (v729.MeshId == "rbxassetid://100663458322564") then
                    return v729;
                end
            end
        end
